...
const UpdatePermissions = () => {
  ...
  const availablePermissions = ['add_vehicle', 'view_vehicle', 'update_vehicle', 'delete_vehicle', 'view_users', 'view_admins', 'update_permissions', 'view_bookings', 'delete_admin']; // You can add more permissions
